export const data =[
    ...
    },
    {
        ...
        content:`The corporate tax cut seems to have worked wonders for the sentiment of the stock market. </br> After gaining around 1900 points on Friday, the market bellwether S&P BSE Sensex opened higher on Monday. </br> The key index surged by over 1,000 points before settling down a little lower. Obviously, </br> mutual fund investors are thrilled by the turn of events, as most market pundits </br> are giving thumbs up to the government move and believe it will change the course of the market positively.`,
    ...
    },
    {
        ...
        content:`Whoever said essay writing is as easy as journaling your thoughts never really wrote a single academic essay.</br> One thing is certain: </br> you can do it and do a good job. Another thing that is certain: it will take time, effort, and a bunch of sacrifices along the way.

        As a professional essay writing service, we know all the ins and outs of academic writing. </br> Some topics are exciting and easy to write about;</br> some requirements are simple and easy to deal with; some deadlines are enough, while others make you regret there are only 24 hours a day. Quality is appreciated by many, but let’s not forget about the text’s originality, list of literature, and valuable findings. After all, the goal behind each essay is to assess one’s ability to think critically and prove one’s knowledge of the selected subject.
        
        Without further delay,</br>  let’s see how our essay writing service can help you get closer to the desired grades omitting anxiety and worthless sacrifices. We’ve got your back, friend!`,
    ...
    },
    {
        ...
        Perched south of Naples, the Amalfi Coast is a gorgeous area of Italy to explore and a spot that everyone should include on their trip around Italy. </br>
        
        There is just so much to see and do, that doesn’t just involve being terrified by the roads. </br>Those colourful villages homes, staggered on terraced cliffs, fragrant lemon groves, delicious freshly made Italian food and turquoise waters, pretty much make this a dream spot. </br>

        You’ll be spoilt for choice when thinking of the best things to do in the Amalfi Coast, especially as it’s so vast. </br>
        
        And that’s the thing, the Amalfi Coast isn’t just one spot. </br>
        
        It’s a collection of lots of different towns and villages, each of which has it’s own unique character and appeal and so you kinda need to decide on a few things before your trip. </br>
        
        Firstly, where to base yourself in the Amalfi Coast when you visit and finally which other places to see. </br>
